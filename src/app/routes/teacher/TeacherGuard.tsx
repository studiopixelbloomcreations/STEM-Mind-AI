      ...
      <div className="min-h-screen w-full bg-[var(--color-bg-base)] flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md space-y-4">
          <div className="flex items-center gap-3 justify-center mb-6">
            <div className="w-8 h-8 rounded-lg bg-[var(--color-accent)] animate-pulse" />
            <span className="text-lg font-display font-bold text-[var(--color-text-primary)]">NexLearn Control Room</span>
          </div>
