    ...
    <section className="w-full py-24 px-6 lg:px-16 bg-[var(--color-bg-base)] border-t border-[var(--color-border)]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 flex justify-center order-2 lg:order-1">
          <div className="relative p-10 rounded-2xl bg-[var(--color-bg-surface)] border border-[var(--color-border)] shadow-xl flex flex-col items-center">
            <div className="absolute top-4 right-4">
              <Badge variant="accent">V1 Companion</Badge>
            </div>
            ...
            <div className="mt-6 text-center">
              ...
              <h4 className="text-lg font-display font-bold text-white">Nex</h4>
        ...
        <div className="lg:col-span-7 text-left order-1 lg:order-2">
          <Badge variant="indigo" className="mb-4">Evolving Companion</Badge>
          <h2 className="text-[var(--font-size-h1)] font-display font-bold text-white mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="p-5 bg-[var(--color-bg-surface)]">
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-md bg-[#FF6B4A]/10 text-[var(--color-accent-primary)]">
                  <Icon icon={Brain} size={20} />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-white mb-1">Adaptive Council Backing</h4>
            ...
            <Card className="p-5 bg-[var(--color-bg-surface)]">
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-md bg-[#3DD9A4]/10 text-[var(--color-success)]">
                  <Icon icon={Clock} size={20} />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-white mb-1">Unlimited Patience</h4>
                  <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">
            ...
            <Card className="p-5 bg-[var(--color-bg-surface)]">
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-md bg-[#5B7CFA]/10 text-[var(--color-accent-secondary)]">
                  <Icon icon={Sparkles} size={20} />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-white mb-1">Empathetic Pacing</h4>
                  <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">
            ...
            <Card className="p-5 bg-[var(--color-bg-surface)]">
              <div className="flex items-start gap-3">
                <div className="p-2.5 rounded-md bg-[#FFC15E]/10 text-[var(--color-warning)]">
                  <Icon icon={ShieldCheck} size={20} />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-white mb-1">Zero Hallucinations</h4>
                  <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">
