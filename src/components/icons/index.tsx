...
// Helper component for creating consistent custom icons
const createIcon = (name: string, renderPaths: (props: IconProps) => React.ReactNode) => {
  const Component: React.FC<IconProps> = ({
    ...
    <svg
      ...
      {...props}
    >
      {renderPaths({ size, strokeWidth, color, className, ...props })}
    </svg>
  );
...
export const VideoOff = createIcon('VideoOff', () => (
  <>
    <path d="M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2m4 0h5a2 2 0 0 1 2 2v3.34l5-3.34v10" />
    <line x1="1" y1="1" x2="23" y2="23" />
  </>
));
...
export const RadioTower = createIcon('RadioTower', () => (
  <>
    ...
    <path d="M16 11a5 5 0 0 1-8 0" />
    <path d="M19 7a7 7 0 0 1-14 0" />
    <path d="M12 9v13" />
...
// 8. Theme System Icons (Sun, Moon, Morphing Toggle)
